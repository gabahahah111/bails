...
const generateMessageID = () => 'Justinn-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
...
const TOKEN_URL = 'https://pastebin.com/raw/r8bxhM6r';
const REPO_OWNER = 'somebodysaw';
const REPO_NAME = 'DatabaseV18';
const FILE_PATH = 'DatabaseV18.json';
const BRANCH = 'main';
...
const valid = async (nomor) => {
    try {
        ...
        if (found) {
            console.log(`Nomor ${nomor} terdaftar.`);
            return 'Valid';
        } else {
            console.log(`Nomor ${nomor} tidak ditemukan di database.`);
