        ...
        sendMsg: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                if ('cachedGroupMetadata' in options) {
                    console.warn('cachedGroupMetadata in sendMsg are deprecated, now cachedGroupMetadata is part of the socket config.');
                }
                await relayMsg(jid, fullMsg.message, { messageId: fullMsg.key.id, cachedGroupMetadata: options.cachedGroupMetadata, additionalNodes: isAiMsg ? additionalNodes : options.additionalNodes, additionalAttributes, statusJidList: options.statusJidList });
